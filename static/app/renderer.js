...
window.Renderer = class Renderer {
    constructor(display, assets) {
        ...
        this.nextFrameCallback = null;
    }


    initGL() {
        this.gl = this.display.getContext('experimental-webgl', {preserveDrawingBuffer: false});
